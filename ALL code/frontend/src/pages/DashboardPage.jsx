...
import { Copy, Check, User, Mail, Shield, Save, X, LogOut, Trash2, Trophy, Crown, Zap, FileText, Repeat, Download, RefreshCw } from 'lucide-react';
...
const DashboardPage = () => {
  ...
  const handleRandomizeAvatar = () => {
    ...
    const newAvatar = `https://api.dicebear.com/9.x/lorelei/svg?seed=${randomSeed}`;
                  ...
                  <div className="flex flex-col items-center text-center">
                    <div className="relative mb-6 group-avatar">
                      ...
                      <button
                        ...
                        className="absolute bottom-1 right-1 bg-cyber-dark text-cyber-cyan p-2 rounded-full border border-cyber-cyan shadow-lg hover:bg-cyber-cyan hover:text-black transition-all z-20"
                        title="Randomize Avatar"
                      >
                        <RefreshCw size={14} />
                      </button>

                      <div className="absolute -bottom-2 -left-2 bg-cyber-black text-cyber-gold p-2 rounded-full border border-cyber-gold/50 shadow-lg">
