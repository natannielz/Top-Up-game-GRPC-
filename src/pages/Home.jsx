      ...
      {featuredGames.map((game, index) => (
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 p-8 space-y-2">
            ...
            <Link to={`/topup/${game.id}`} className="inline-flex items-center gap-2 mt-4 text-cyber-cyan font-bold hover:text-white transition-colors">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="max-w-md mx-auto mb-12 relative z-20 px-4">
          <div className="bg-cyber-dark/80 backdrop-blur-xl p-1.5 rounded-2xl flex relative border border-white/10 shadow-[0_0_30px_rgba(0,0,0,0.5)]">
            {/* Sliding Background */}
            <div
              className={`absolute top-1.5 bottom-1.5 w-[calc(50%-6px)] rounded-xl transition-all duration-400 ease-out z-0
